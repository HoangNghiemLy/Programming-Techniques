...
void InputPSArr (PHANSO p[],int &n);
void OutputPSArr (PHANSO p[],int n);
	...
	do 
	{
		...
		switch (chon)
		{
			...
			case 6 : printf ("Nhap phan so 1 : ");InputPS(ps1);
					 printf ("Nhap phan so 2 : ");InputPS(ps2);
					 ps = TichPS(ps1, ps2); 
					 printf ("Phan so tich ps1*ps2 = "); OutputPS(ps); break ;
			case 7 : printf ("Nhap phan so 1 : ");InputPS(ps1);
					 printf ("Nhap phan so 2 : ");InputPS(ps2);
					 ps = ThuongPS(ps1, ps2); 
					 printf ("Phan so thuong ps1/ps2 = "); OutputPS(ps); break ;
			case 8 : InputPSArr(p,n); OutputPSArr(p,n);break;
